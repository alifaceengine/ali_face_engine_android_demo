...
public class FaceRecognizeNoDB {
    ...
    public RecognizeResult recognizeFeatureOfPerson(String personId, String feature) {
        return FaceRecognizeNoDBJNI.recognizeFeatureOfPerson(mContext, personId, feature);
    }
}
